...
# /opt/riscv/bin/riscv64-unknown-elf  ya da /home/kerim/rv32i/bin/riscv32-unknown-elf
...
CFLAGS = $(PORT_CFLAGS) -march=rv32i -mabi=ilp32 -I$(PORT_DIR) -I. -DFLAGS_STR=\"$(FLAGS_STR)\" #-DCORE_DEBUG
# -DITERATIONS=1000
#Flag: LFLAGS_END
...
PORT_SRCS = $(PORT_DIR)/core_portme.c $(PORT_DIR)/ee_printf.c $(PORT_DIR)/crt.S $(PORT_DIR)/syscalls.c  #$(PORT_DIR)/init.c #$(PORT_DIR)/syscalls.c #$(PORT_DIR)/crt.S
ITERATIONS = 1
# Flag: LOAD
